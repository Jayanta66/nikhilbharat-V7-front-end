  ...
  return (
    <div>
      ...
      <div>
        ...
        <h1 style={{color: "red"}}>To add anything please follow these setting on you chrome browser > goto three dot > Settings > Privacy  and security > security > advanced > use secure DNS > turn on > select dns provider > cloudflare(1.1.1.1)</h1>
